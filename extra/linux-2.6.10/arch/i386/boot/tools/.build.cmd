cmd_arch/i386/boot/tools/build := gcc -Wp,-MD,arch/i386/boot/tools/.build.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer      -Iinclude   -o arch/i386/boot/tools/build arch/i386/boot/tools/build.c
